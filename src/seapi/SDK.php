...
class SDK {
    ...
    public function post($path, array $data)
    {
        try {
            ...
            throw new Exception("\nSomething went wrong with API-post request. Error: \n" . $e->getMessage(), 500, $e);
        }
    }
    ...
    protected function patch($path, array $data)
    {
        try {
            ...
            throw new Exception("\nSomething went wrong with API-patch request. Error: \n" . $e->getMessage(), 500, $e);
        }
    }
    ...
    public function put($path, array $data)
    {
        try {
            ...
            throw new Exception("\nSomething went wrong with API-put request. Error: \n" . $e->getMessage(), 500, $e);
        }
    }
    ...
    public function delete($path, $data)
    {
        try {
          ...
          throw new Exception("\nSomething went wrong with API-delete request. Error: \n" . $e->getMessage(), 500, $e);
        }
    }
    ...
    public function get($path, $options = null)
    {
        ...
        try {
            ...
            throw new Exception("\nSomething went wrong with API-get request. Error: \n" . $e->getMessage(), 500, $e);
        }
    }
